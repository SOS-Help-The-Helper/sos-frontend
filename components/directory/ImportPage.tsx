      ...
      <div className="min-h-screen text-white">
        <header className="sticky top-0 z-30 glass border-b border-[var(--hairline)]">
          <div className="max-w-[800px] mx-auto px-5 md:px-10 h-12 flex items-center">
            <Link href="/app/directory" className="inline-flex items-center gap-1 text-[15px] text-[#89CFF0] -ml-1.5">
              <ChevronLeft size={20} />
              <span>Directory</span>
            </Link>
          </div>
              ...
              {stage === "mapping" && (
                <>
                  ...
                  <div className="mt-6 flex items-center justify-between gap-3">
                    <Link href="/app/directory" className="text-[14px] text-white/55 hover:text-white">Cancel</Link>
                    <button
                      onClick={startImport}
              ...
              {stage === "done" && (
                <div className="mt-6 rounded-2xl bg-[var(--surface-1)] border border-[var(--hairline)] p-6">
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-2">
                    <Link href="/app/directory" className="px-5 h-11 rounded-full bg-[#89CFF0] text-[#0F1E2B] font-medium hover:bg-[#9bd5f2] inline-flex items-center justify-center text-[14px]">
                      View directory
                    </Link>
