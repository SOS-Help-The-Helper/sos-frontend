...
const PORTAL_CONFIGS: Record<string, PortalConfig> = {
  ...
  citizen: {
    ...
    agent: { welcome: 'Everyone is a helper. Need something? We\'ll match you. Have something to offer? We\'ll connect you. Most people do both.', suggestions: ['I need help', 'I can help', 'What\'s near me?'] },
