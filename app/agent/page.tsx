...
export default function Agent() {
  return (
    <DashboardShell title="SOS Agent" subtitle="Chat with your coordination agent">
      <div className="bg-white rounded-xl border border-sos-gray-300 p-8 text-center">
        ...
        <h3 className="text-base font-bold text-sos-blue-800">Partner Agent</h3>
        <p className="text-sm text-sos-gray-600 mt-1 max-w-md mx-auto">
          Coming soon — chat with your SOS coordination agent directly from the dashboard. Slack and WhatsApp work in the meantime.
        </p>
      </div>
    </DashboardShell>
  );
