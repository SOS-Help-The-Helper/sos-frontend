                ...
                {open && (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 4,
                      boxShadow: "0 20px 50px rgba(15,30,43,0.18)",
                      width: 320,
                      zIndex: 50,
                      overflow: "hidden",
                    }}
                        ...
                        return (
                          <Link
                            ...
                            style={{
                              ...
                              borderRadius: 2,
                              textDecoration: "none",
                              background: itemActive ? "var(--sos-card-gray)" : "transparent",
                              transition: "background 120ms",
                            }}
                            onMouseEnter={(e) => {
                              e.currentTarget.style.background = "var(--sos-card-gray)";
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.background = itemActive ? "var(--sos-card-gray)" : "transparent";
                            }}
                          >
                            <span
                              style={{
