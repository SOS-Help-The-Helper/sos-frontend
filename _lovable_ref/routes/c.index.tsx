...
export const Route = createFileRoute("/c/")({
  head: () => ({ meta: [{ title: "SOS · Find help near me" }] }),
...
function CitizenMap() {
  return (
    <CitizenShell title="Find help near me">
      ...
      <div className="px-4 mt-4">
        <div className="rounded-2xl bg-[var(--surface-1)] border border-[var(--hairline)] aspect-square relative overflow-hidden">
      ...
      <div className="px-4 mt-6">
        ...
        <div className="space-y-2">
          {programs.slice(0, 4).map((p) => (
            <div key={p.id} className="rounded-2xl bg-[var(--surface-1)] border border-[var(--hairline)] p-4">
