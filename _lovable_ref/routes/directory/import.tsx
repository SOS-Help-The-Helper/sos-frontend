...
export const Route = createFileRoute("/directory/import")({
  head: () => ({
    meta: [
      { title: "Import Contacts — SOS Connect" },
      { name: "description", content: "Bulk import contacts into the SOS Connect directory." },
    ],
  }),
